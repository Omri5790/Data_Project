...
2. Data Collection
### Web Scraping
We used Python libraries like `Selenium`, `BeautifulSoup` to scrape hotel search results from Booking.com and Expedia.com. Our scraping criteria included:
- Location: New York
...
7. Reverse Engineering Sorting Algorithms
